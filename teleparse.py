...
\__    ___/___ |  |   ____\______   \_____ _______  __________
  |    |_/ __ \|  | _/ __ \|     ___/\__  \\_  __ \/  ___/ __ \
  |    |\  ___/|  |_\  ___/|    |     / __ \|  | \/\___ \  ___/
  |____| \___  >____/\___  >____|    (____  /__|  /____ >\___  >
             \/          \/               \/           \/    \/ 
Version: %s
Programador: %s
Github: https://github.com/nicotrial

Usage: python teleparse.py -h (for help)
Example: Usage: python teleparse.py -f cache4.db -em
""" % ('0.1', 'Nicotrial')
